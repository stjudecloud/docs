...
![PeCan Suptype Tree](/img/pecan/overview/getting-started/Subtype_Tree.png)
**Figure 3: Subtype Tree** A user is able to explore the tree by selecting the interactive nodes.
