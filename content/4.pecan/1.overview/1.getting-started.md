...
=======
To get started (**Figure 1**), click our navigational membrane which navigates the user to our sunburst and data facets or use the search bar to select a diagnosis, gene, or variant.
>>>>>>> d2d49bd (docs: side navigation update)
...
Additionally, a user can navigate by using our navigational membrane or begin searching a dignosis, gene, or variant of interest.
