...
Access specific `Associated Study` links for subsets of data, such as the Medulloblastoma example [here](https://pecan-v2.staging.stjude.cloud/variants/oncoprint/BT%7CMB).
::
...
5. Love, M. I., Huber, W., & Anders, S. (2014). Moderated estimation of fold change and dispersion for RNA-seq data with DESeq2. Genome Biology, 15(12), 550. [https://doi.org/10.1186/s13059-014-0550-8](mailto:https://doi.org/10.1186/s13059-014-0550-8)
