...
description: Pediatric Cancer (PeCan) Knowledge Base
---
...
Learn more about the data [here](https://university.stjude.cloud/docs/pecan/data/).
...
<div class="flex flex-row">
  <div class="pr-8 pt-0 flex-none">
    <a href="../data-facets/variants"><img src="/img/pecan/overview/getting-started/variants.svg" alt="Variants"></a>
  </div>
  <div>
    <h5 class="font-bold"><a href="../data-facets/variants" class="text-blue-primary">Variants</a></h5>
...
<div class="flex flex-row">
  <div class="pr-8 pt-0 flex-none">
    <a href="../data-facets/mutational-signatures"><img src="/img/pecan/overview/getting-started/mutational-signatures.svg" alt="Mutational Signatures"></a>
  </div>
  <div>
    <h5 class="font-bold"><a href="../data-facets/mutational-signatures" class="text-blue-primary">Mutational Signatures</a></h5>
...
<div class="flex flex-row">
  <div class="pr-8 pt-0 flex-none">
    <a href="../data-facets/expression"><img src="/img/pecan/overview/getting-started/expression.svg" alt="Expression"></a>
  </div>
  <div>
    <h5 class="font-bold"><a href="../data-facets/expression" class="text-blue-primary">Expression</a></h5>
...
<div class="flex flex-row">
  <div class="pr-8 pt-0 flex-none">
    <a href="../data-facets/histology"><img src="/img/pecan/overview/getting-started/histology.svg" alt="Histology" ></a>
  </div>
  <div>
    <h5 class="font-bold"><a href="../data-facets/histology" class="text-blue-primary">Histology</a></h5>
...
<div class="flex flex-row">
  <div class="pr-8 pt-0 flex-none">
    <a href="../pecan-pie/what-is-pie"><img src="/img/pecan/overview/getting-started/pie.svg" alt="PIE"></a>
  </div>
  <div>
    <h5 class="font-bold"><a href="../pecan-pie/what-is-pie" class="text-blue-primary">PIE (the <strong>Pe</strong>diatric <strong>Can</strong>cer Variant <strong>P</strong>athogenicity <strong>I</strong>nformation <strong>E</strong>xchange</a></h5>
