...
For a description about each field, see our [How to use our Editor](/visualization-community/getting-started/how-to-use-the-viseditor) section.
There are 2 ProteinPaint tracks that must render from our Traditional Code Editor: [Lollipop](/visualization-community/code-block-library/1lollipop) and [Track List and Data Facet](/visualization-community/code-block-library/1track-list-and-facet-table).
