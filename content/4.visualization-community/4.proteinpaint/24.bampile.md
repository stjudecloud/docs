...
![image 1](/img/visualization-community/proteinpaint/bampile/image1.png)
...
Node.js v6.0 and above is required.
Linux binaries are available at [https://nodejs.org/dist/v6.9.1/node-v6.9.1-linux-x64.tar.xz](https://nodejs.org/dist/v6.9.1/node-v6.9.1-linux-x64.tar.xz)
...
[https://proteinpaint.stjude.org/?block=on&genome=**hg19**&position=chr13:48941549-48941948&bampilefile=**SAMPLE,ultra/SAMPLE.gz**](https://proteinpaint.stjude.org/?block=on&genome=hg19&position=chr13:48941549-48941948&bampilefile=SAMPLE,ultra/SAMPLE.gz)
