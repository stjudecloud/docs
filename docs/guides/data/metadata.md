...
| sj_diseases            | Short disease identifier assigned at the time genomic sequencing was ordered for the sample. Note that this diagnosis may be refined after undergoing genomic testing. When including diagnosis in your analysis, we recommend you use `attr_diagnosis`, which is the most updated value for diagnosis.                                                                                              |
...
| attr_diagnosis        | Primary diagnosis at the time of sample submission to St. Jude Cloud as reported by the physician.                                                                                                                                                                                                    |
