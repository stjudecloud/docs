...
!!! warning "Potential Bacterial Contamination"
    ...
    4. Last, we will be working over the coming months to unmap the reads originating from bacterial contamination and release the associated `gVCF` files from Microsoft Genomics Service.
